    ...
    const fetchNotes = async () => {
      try {
        ...
        const filteredNotes = data.filter(
          (note) => note.subject.toLowerCase().replace(/\s+/g, '-') === (subjectId || "").toLowerCase()
        )

        // Console log to debug filtered notes
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {notes.map((note) => (
              ...
              >
                ...
                {/* Creator Info */}
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-violet-50 rounded-xl border border-indigo-100">
                  <div className="w-10 h-10 bg-gradient-to-r from-blue-200 to-violet-200 rounded-full flex items-center justify-center">
