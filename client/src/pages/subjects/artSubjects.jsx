...
const ArtSubjects = () => {
      ...
      const subjectList = [
        {
          id: "Sinhala",
          name: "Sinhala",
          description: "සිංහල භාෂාව හා සාහිත්‍යය පිළිබඳ සවිස්තරාත්මක අධ්‍යයනය",
        ...
        },
        {
          id: "Geography",
          name: "Geography",
          description: "ලෝකයේ භූගෝලීය ලක්ෂණ සහ සංකල්ප පිළිබඳ අධ්‍යයනය",
        ...
        },
        {
          id: "Economics",
          name: "Economics",
          description: "ආර්ථික විද්‍යාවේ මූලික සංකල්ප සහ න්‍යායන්",
        ...
        {
          id: "Buddhist Culture and Logic",
          name: "Buddhist Culture and Logic",
          description: "බුද්ධ ධර්මය හා තර්ක ශාස්ත්‍රය පිළිබඳ අධ්‍යයනය",
  ...
  const handleViewSessions = (subjectId, subjectName) => {
    ...
    try {
      navigate(`/art/artSessions?subject=${encodeURIComponent(subjectId)}`)
    } catch (error) {
  ...
  const handleViewNotes = (subjectId, subjectName) => {
    ...
    try {
      navigate(`/art/artNotes?subject=${encodeURIComponent(subjectId)}`)
    } catch (error) {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-100">
        <div className="text-center">
          ...
          <p className="text-slate-600 font-medium">Loading Arts Stream Subjects...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="mb-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto flex items-center justify-center gap-3 leading-relaxed">
              ...
              Comprehensive humanities and language-focused curriculum designed for academic excellence
            </p>
          ...
          {subjects.map((subject) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                {/* Subject Metadata (Removed difficulty and duration) */}
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/40 max-w-4xl mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto">
                Access interactive video sessions, comprehensive study notes, and expert guidance across all Arts stream
                subjects. Build a strong foundation in humanities and language studies with our premium educational
                platform.
              </p>
