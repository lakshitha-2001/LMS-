        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-cyan-700 via-teal-600 to-emerald-700 bg-clip-text text-transparent">
              {subjectId ? subjectId : "Unknown Subject"} Sessions
            </h1>
            ...
            {sessions.map((session) => (
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center text-slate-600">
                    <Clock className="w-4 h-4 mr-3 text-cyan-500" />
                ...
                {/* Teacher Info */}
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-cyan-50 to-emerald-50 rounded-xl mb-6 border border-teal-100">
                  <img
                    src={
                      session.teacher?.img ||
