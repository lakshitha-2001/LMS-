...
const TechnologySubjects = () => {
  ...
  const fetchSubjectData = async () => {
    try {
      ...
      const subjectList = [
        {
          id: "Engineering & Bio System Technology",
          name: "Engineering Technology",
          description: "ඉංජිනේරු තාක්ෂණයේ මූලික සංකල්ප සහ යෙදුම්",
        ...
        },
        {
          ...
          description: "තාක්ෂණය සඳහා විද්‍යාත්මක පදනම්",
        ...
        },
        {
          id: "ICT",
          name: "ICT",
          description: "තොරතුරු හා සන්නිවේදන තාක්ෂණය",
        ...
        {
          id: "Agriculture and Applied Sciences",
          name: "Bio Systems Technology",
          description: "ජීව විද්‍යාත්මක පද්ධති සහ තාක්ෂණය",
      ...
      const updatedSubjects = subjectList.map((subject) => {
        ...
        console.log(`Subject: ${subject.name}, Sessions: ${sessionCount}, Notes: ${noteCount}`)
  ...
  const handleViewSessions = (subjectId, subjectName) => {
    ...
    try {
      console.log(`Navigating to sessions for subject: ${subjectId}`)
      navigate(`/technology/techSessions?subject=${encodeURIComponent(subjectId)}`)
    } catch (error) {
  ...
  const handleViewNotes = (subjectId, subjectName) => {
    ...
    try {
      console.log(`Navigating to notes for subject: ${subjectId}`)
      navigate(`/technology/techNotes?subject=${encodeURIComponent(subjectId)}`)
    } catch (error) {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-100">
        <div className="text-center">
          ...
          <p className="text-slate-600 font-medium">Loading Technology Stream Subjects...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="mb-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto flex items-center justify-center gap-3 leading-relaxed">
              ...
              Modern technology and applied sciences for tomorrow's innovators
            </p>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/40 max-w-4xl mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto">
                Access interactive video sessions, comprehensive study notes, and expert guidance across all Technology stream
                subjects. Build a strong foundation in modern technologies and applied sciences with our premium educational platform.
              </p>
